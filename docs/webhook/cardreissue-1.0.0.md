...
```
{
	...
	"type": "object",
	"description": "This event is generated when a card is reissued.",
	"properties": {
		"header": {
			"type": "object",
			"properties": {
		...
		"data": {
			...
			"previousCard": {
				...
				"properties": {
					"oldCardNumber": {
						"type": "string",
						"description": "Encrypted previous card number provided in place of the true PAN as additional level of security"
					},
					"oldMemberNumber": {
						"type": "string",
						"description": "Previous Unique number associated with each member of the card"
					},
					"oldCardExpirationDate": {
						"type": "string",
						"description": "Previous Month and year the card record was set to expire.",
						"format": "MM/YY"
					}
				}
			},
...
```
{
    "header": {
       ...
       "eventCode": "Reissue",
       "operationType": "Add",
       "eventDateTime": "2023-05-11T07:36:36Z",
       "eventVersion": "1.0.0",
       "source":"C"
    },
    "data": {
      ...
      "securityInfo":{
       ...
       "previousCard": {
          "oldCardNumber": "433141S18EN8767",
          "oldMemberNumber": "1",
          "oldCardExpirationDate": "12/22"
       },
       "additionalAttributes": {
          "cardFeature": "0"
       }
